...
void gameover(){
	...
	cout<<"\t\t--------------------------"<<endl<<endl;
	cout<<"\t\t tekan sebarang untuk pergi ke menu.";
	getch();
}
void updateScore(){
...
void instructions(){
	...
	cout<<"Instruksi";
	cout<<"\n----------------";
	cout<<"\n menghindari mobil dengan bergerak ke kiri atau ke kanan. ";
	cout<<"\n\n Tekan 'A' untuk bergerak ke kiri";
	cout<<"\n Tekan 'D' untuk bergerak ke kanan";
	cout<<"\n Tekan 'Spasi' untuk keluar";
	cout<<"\n\n tekan sebarang untuk pergi ke menu";
	getch();
}
...
void play(){
	...
	gotoxy(18, 5);cout<<" tekan sebarang untuk memulai ";
	getch();
	gotoxy(18, 5);cout<<"                      ";
